...
namespace Pet_Clinic_Management_System
{
    public partial class updateOwnerAddress : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (ownerID.Text != "" || houseNo.Text != "" || street.Text != "" || city.Text != "")
            {
                int ownrID = int.Parse(ownerID.Text);
                string house = houseNo.Text;
                ...
                string qry = "UPDATE owner SET houseNo = '" + house + "' , street = '" + st + "' , city = '" + cty + "' WHERE ownerID = " + ownrID + "; ";
