...
{
    public partial class updateDoctorName : Form
    {
        public updateDoctorName()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (doctorID.Text != "" || doctorName.Text != "")
            {
                ...
                string qry = "UPDATE doctor SET doctorName = '" + docName + "' WHERE doctorID = " + docID + "; ";
