...
{
    public partial class updateOwnerPhn : Form
    {
        public updateOwnerPhn()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (ownerID.Text != "" || ownerPhn.Text != "")
            {
                int ownrID = int.Parse(ownerID.Text);
                string phn = ownerPhn.Text;
                ...
                string qry = "UPDATE owner SET contactNo = '" + phn + "' WHERE ownerID = " + ownrID + "; ";
